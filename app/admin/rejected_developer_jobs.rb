ActiveAdmin.register Job, as: "RejectedDeveloperJob" do
  permit_params :title, :job_link, :location, :longitude, :latitude, :description, :source, :source_id, :status, :company, :status_reason, :salary, :reviewed, :requires_stem_degree, :requires_experience, :edited, :company_id, :scraped_company, :remote_status, :tag_list
