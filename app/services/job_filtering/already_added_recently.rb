module JobFiltering
  class AlreadyAddedRecently < BaseHandler
    ...
    def handle(job)
      reject_job(job, message: "Rejected: Job link has already been added within 1 week. @identical_links_already_approved: #{@identical_links_already_approved}. @identical_description_already_approved: #{@identical_description_already_approved}. @identical_data_already_approved: #{@identical_data_already_approved}")
      reject_job(job, message: "Rejected: Job link has already been added within 1 week. @identical_links_already_approved: #{@identical_links_already_approved}. @identical_description_already_approved: #{@identical_description_already_approved}. @identical_data_already_approved: #{@identical_data_already_approved}")
